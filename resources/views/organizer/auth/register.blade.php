...
<head>
    ...
    <title>Sign up | GB ArtBazaar</title>
...
<body class="signup-signin-page">
    <div class="signup-signin-container">
        ...
        <div class="inner-container-signup-signin">
            ...
            <form class="signin-signup-form" method="POST" action="{{ route('organizer.registerForApprovel') }}">
                @csrf
                ...
                <div><input class="input-container" type="password" placeholder="Confirm Password" id="confirm_password"
                    ...
                    <div>
                        ...
                        <p>Already have an account? <a href="{{ route('organizer.login') }}">Login</a> here</p>
