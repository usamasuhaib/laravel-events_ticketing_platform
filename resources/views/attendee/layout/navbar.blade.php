    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
                ...
                <div class="nav-item image user-panel mt-1 pb-1 mb-1 d-flex">
                    ...
                    @if ($profileImage)
                        <img class="profile-user-img img-fluid img-circle"
                            src="{{ asset('storage/attendee-profile-images/' . Auth::guard('attendee')->user()->profile_image) }}"
                            alt="Profile img">
                    @else
                        <img class="profile-user-img img-fluid img-circle"
            ...
            <p class="text-muted text-center">Attendee</p>
                ...
                <a href="{{ route('attendee.profile') }}" class="dropdown-item">
                    <i class="fa-solid fa-user fa-lg mr-3"></i> Show Profile
                </a>
                <div class="dropdown-divider"></div>
                <a href="{{ route('attendee.passwordUpdateForm') }}" class="dropdown-item">
                ...
                <div class="dropdown-divider"></div>
                <a href="{{ route('attendee.logout') }}" class="dropdown-item dropdown-footer">
