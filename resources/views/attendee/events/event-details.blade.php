                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('attendee.stripe', $event->id) }}" class="btn btn-primary btn-lg btn-flat">
                                    <i class="fas fa-cart-plus fa-lg mr-2"></i>
                                    Checkout
                                </a>
                                @if ($eventIsInWishlist)
                                    <a href="{{ route('attendee.removeFromWishlist', ['eventId' => $event->id]) }}" class="btn btn-default btn-lg btn-flat">
                                        <i class="fa-regular fa-trash-can fa-lg"></i>
                                        Remove from Wishlist
                                    </a>
                                @else
                                    <a href="{{ route('attendee.addToWishlist', ['eventId' => $event->id]) }}" class="btn btn-default btn-lg btn-flat">
